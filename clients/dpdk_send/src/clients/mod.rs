...
impl AsyncLogClient for SCMapClient {
    type V = [(u32, u32)];
    ...
    fn after_op(&mut self, mut buf: MessageBuffer) -> MessageBuffer {
        ...
        buf.as_append(self.col.into(), &[(7, val1), (11, val2), (13, val3)] ,&[]);
        buf
    }
}


pub struct DebugSingleColumnMapClient {
    map: HashMap<u32, u32>,
...
impl DebugSingleColumnMapClient {
    pub fn new(column: u32) -> Self {
        DebugSingleColumnMapClient {
            map: HashMap::new(),
...
impl AsyncLogClient for DebugSingleColumnMapClient {
    type V = [(u32, u32)];
    ...
    fn after_op(&mut self, mut buf: MessageBuffer) -> MessageBuffer {
        ...
        if self.op_count < 10 {
            trace!("gonna write {}", self.op_count);
...
pub mod test {
    ...
    use types::*;
    use scheduler::{Scheduler, AsyncClient};
    ...
    mod single_col {
        ...
        use clients::DebugSingleColumnMapClient as Client;
        ...
        fn single_client_local2() {
            super::local_run(1, |port| AsyncLog::new(Client::new(3) /*TODO*/, port), 100);
        }
    }

    pub fn local_run<C, F: FnMut(u16) -> C>(clients: u16, constructor: F, iters: usize)
    where C: AsyncClient {
        const BURST_SIZE: u16 = 8;
        let mut chains = HashMap::with_capacity(iters);
        let mut recvs = Vec::with_capacity(BURST_SIZE as usize);
